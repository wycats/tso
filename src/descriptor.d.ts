...
export declare type ErrorPath = ReadonlyArray<string>;
/**
 * @api public
 *
 ...
 */
export declare type Validator<T = unknown> = (value: T, context: Option<string>) => Task<ValidationError[]>;
/**
 * @api primitive
 *
 * A low-level representation of a validation.
 */
export declare type ValidationDescriptor<T = unknown, Options = unknown> = Readonly<{
    name: string;
